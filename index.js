...
//        "x": "ch", //x for (ba)ch skal vi visst bruke
    ...
    tekst = tekst.replace(/ˈ([^aeiouyæøå]*)([aeiouyæøå]{1,2})/gu, (match, k, v) => k + "<i>" + v + "</i>"); //IPA-kursivtrykk, diftongar inkludert
...
const tillatne = ["å", "ç", "ʃ", "ʒ", "ə", "ŋg", "ŋ", "þ", "m̥", "ɱ̊", "ɱ", "n̥", "ɳ̊", "ɳ", "ɲ̊", "ɲ", "ŋ̊", "ɴ̥", "ɴ", "p̪", "ȹ", "ȸ", "t̼", "ʲ", "ʷ", "ʈ", "ɖ", "c", "ɟ", "q", "ɢ", "ʡ", "ʔ", "ʂ", "ʐ", "ɕ", "ʑ", "ɸ", "β", "θ", "ð", "ʝ", "ɣ", "ɣ̞", "χ", "ʀ̝̊", "ʁ", "ħ", "ʕ", "ɦ", "ʋ", "ɹ", "ɻ", "˞", "ɰ", "ʔ̞", "ⱱ̟", "b̆", "ⱱ", "ɾ̥", "ɾ", "ɽ̊", "ɽ", "ɖ̆", "ɢ̆", "ʀ̆", "ɢ̞̆", "ʡ̆", "ʡ̮", "ʡ̯", "ʙ̥", "ᴘ", "ʙ", "r̥", "ʀ̥", "ʀ", "ʜ", "ʢ", "ɬ", "ɮ", "ꞎ", "ʎ̥", "ʎ̝", "ɥ", "ʟ̥", "ʟ̝", "l̥", "ɭ̊", "ɭ", "ʎ̥", "ʎ", "ʟ̥", "ʟ", "ʟ̠", "ɺ̥", "ɺ", "ɺ̠", "ʎ̆", "ʎ̮", "ʎ̯", "ʟ̆", "w", "ÿ", "ʏ̈", "ɨ", "ɨ̞", "ʉ", "ɯ", "ɯᵝ", "ɯ̞ᵝ", "u", "ɪ", "ɪ̯", "Y", "ʊ", "ɘ", "ɵ", "ɤ", "o", "e̞", "ɛ̝", "ø̞", "œ̝", "ɤ̞", "ʌ̝", "o̞", "ɔ̝", "ɛ", "œ", "ɜ", "ɞ", "ʌ", "ɔ", "ɐ", "a", "ɶ", "ä", "ɑ̈", "ɑ̟", "ɐ̞", "ɑ", "ɒ"]
...
function oppdater(){
    ...
    endraTekst = fjernDiakratiske(endraTekst, tillatne); //fjern diakratiske teikn som ikkje blir omsett
